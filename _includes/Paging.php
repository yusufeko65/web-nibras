...
class Paging{
	...
	public function GetPaging2($total,$baris,$page,$jmlpage,$linkpage,$linkcari,$amenu){
		...
		if ($jmlpage>0){
			if ($page > 1){
				$this->pages = $page-1;
				$this->prev = "<li><a href=\"".URL_PROGRAM.$amenu.$linkpage."page_$this->pages/$linkcari \">Prev</a></li>";
				$this->first = "<li><a href=\"".URL_PROGRAM.$amenu.$linkpage."page_$this->first/$linkcari \">First</a></li>";
			} else {
				$this->prev = "<li class=\"disabled\"><a>Prev</a></li>";
				$this->first = "<li class=\"disabled\"><a>First</a></li>";
			}
		}
		for($this->pages = 1; $this->pages <= $jmlpage; $this->pages++){
			if ((($this->pages >= $page - 1) && ($this->pages <= $page + 1)) || ($this->pages == 1) || ($this->pages == $page)){   
				if (($this->showPage == 1) && ($this->pages != 2)) $this->tlink.="<li class=\"disabled\"><a>...</a></li>"; 
				if (($this->showPage != ($jmlpage - 1)) && ($this->pages == $jmlpage)) $this->tlink.="<li class=\"disabled\"><a>...</a></li>";
				if ($this->pages == $page) $this->tlink.="<li class=\"active\"><a>$this->pages</a></li>";
				else $this->tlink.=" <li><a href=\"".URL_PROGRAM.$amenu.$linkpage."page_$this->pages/$linkcari \">".$this->pages."</a></li> ";
				$this->showPage = $this->pages;          
			}
		}
		if($jmlpage>0){
			if (($page < $jmlpage && $page >= 1)){
				$this->pages = $page+1;
				$this->last =  "<li><a href=\"".URL_PROGRAM.$amenu.$linkpage."page_$this->last/$linkcari \"> Last</a></li>";
				$this->next =  "<li><a href=\"".URL_PROGRAM.$amenu.$linkpage."page_$this->pages/$linkcari \"> Next</a></li>";
			} else {
				$this->last = "<li class=\"disabled\"><a>Last</a></li>";
				$this->next = "<li class=\"disabled\"><a>Next</a></li>";
			}
		}
		return $this->first.$this->prev.$this->tlink.$this->next.$this->last;
	}
