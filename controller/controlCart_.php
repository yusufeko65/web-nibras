			...
			if ($simpan) {
				...
				*/
				...
				if ($data['biaya_packing'] > 0) {
					...
					$tabel .= '<td style="text-align:right;margin:0;padding:10px" align="right" bgcolor="#ffffff">(' . $this->Fungsi->fFormatuang((int) $data['biaya_packing']) . ')</td>';
					$tabel .= '</tr>';
				}
