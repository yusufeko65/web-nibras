...

{
...

	{
		...
		$sql = "select idpesanan,_order.pesanan_no,
				...
				status_nama as status,_order.status_id, biaya_packing,
...

	{
		...
		$sql = "select o.pesanan_no,o.pelanggan_id,c.cust_nama,cg.cg_nm as grup_cust,cg.cg_deposito,
				...
				o.no_awb,o.dari_deposito,o.dropship,o.kurir_konfirm,o.keterangan,o.tampil_label_keterangan, o.biaya_packing,
...

	{
		...
		$sql = "insert into _order 
				...
				(null,'" . $data['nopesanan'] . "','" . $data['cust_id'] . "',
				 ...
				 '" . $data['kurir_konfirm'] . "','" . $this->user . "','','0','" . $data['biaya_packing'] . "')";
