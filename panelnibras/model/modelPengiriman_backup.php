...
class modelPengiriman
{
    ...
    public function __construct()
    {
        ...
        $this->status_resi ="(_order.kurir <> 'undefined' or _order.kurir <> '') and (_order.status_id = 11 or _order.status_id = 18)";
    ...
    public function getOrderLimit($batas, $baris, $data, $resi = false, $today
        ...
        if ($resi) {
            $filter[] = $this->status_resi;
            $order = " field(_order.no_awb, '-') desc, _order.pesanan_no desc "
            ;
        } else {
            $filter[] = $this->status;
