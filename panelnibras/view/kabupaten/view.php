...
<div class="col-lg-12 main-content">
	...
	<div class="row">
		...
		<div class="col-md-6 bagian-tombol"><a href="<?php echo URL_PROGRAM_ADMIN . folder . "/?op=add&u_token=" . $u_token ?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit"></span> Tambah</a> <a class="btn btn-warning btn-sm" onclick="hapusdata()"><span class="glyphicon glyphicon-trash"></span> Hapus</a></div>
	</div>
	<table class="table table-bordered table-striped table-hover tabel-grid">
		...
		<tbody id="viewdata">
			...
			<tr>
				...
				<td class="tengah"><a href="<?php echo URL_PROGRAM_ADMIN . folder . "/?op=edit&pid=" . $datanya['kabupaten_id'] . '&u_token=' . $u_token ?>" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-pencil"></span></a></td>
			</tr>
			<?php } ?>
		</tbody>
	</table>
...
<script>
	...
	function caridata() {
		...
		location = '<?php echo URL_PROGRAM_ADMIN . folder . '/?datacari=' ?>' + zdata + '&propinsi=' + propinsi + '&u_token=<?php echo $u_token ?>';
