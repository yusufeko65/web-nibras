		...
		<div class="table">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr <?php echo $kelasgrid ?>>
				<td><input type="checkbox" class="chk" value="<?php echo $datanya['produsen_id']?>" /></td>
				<td><?php echo $datanya["produsen_nama"]?>
				    <?php if($datanya['produsen_logo']!='' || $datanya['produsen_logo'] != '-') { ?>
					<br><img src="<?php echo URL_IMAGE.'_other/other_'.$datanya["produsen_logo"]?>">
				    <?php } ?>
				</td>
				<td><a class="ico edit" onclick="tampilkan('<?php echo URL_PROGRAM_ADMIN.folder."/?op=edit&pid=".$datanya['produsen_id']?>')">Edit</a></td>
			  </tr>
			  <?php } ?>
			</table>
			<?php if($total>0) { ?>
