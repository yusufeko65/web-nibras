		...
		<div class="table">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				 ...
				 <th width="30%">Kotamadya/Kabupaten</th>
			  ...
			  <tr <?php echo $kelasgrid ?>>
				<td><input type="checkbox" class="chk" value="<?php echo $datanya['kecamatan_id']?>" /></td>
				<td><?php echo $datanya["kecamatan_nama"]?></td>
				<td><?php echo $datanya["kabupaten_nama"]?></td>
				<td><?php echo $datanya["provinsi_nama"]?></td>
				<td><a class="ico edit" onclick="tampilkan('<?php echo URL_PROGRAM_ADMIN.folder."/?op=edit&pid=".$datanya['kecamatan_id']?>')">Edit</a></td>
			  </tr>
			  <?php } ?>
			</table>
			<?php if($total>0) { ?>
