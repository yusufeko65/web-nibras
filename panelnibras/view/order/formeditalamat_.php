<form method="POST" name="frmeditlamat" id="frmeditlamat" action="<?php echo $_SERVER['PHP_SELF'] ?>">
	...
	<input type="hidden" name="cari" id="cari" value="<?php echo $cari ?>">
			...
			<div class="modal-body">
				...
				<div role="tabpanel" id="tabpanel">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" id='tabform' class="active"><a href="#formalamat" aria-controls="formalamat" role="tab" data-toggle="tab">Alamat</a></li>
						<li role="presentation" id='tabdata'><a href="#dataalamat" role="tab" data-toggle="tab">Data Alamat</a></li>
					</ul>
					<div class="tab-content">
						...
						<div role="tabpanel" class="tab-pane" id="dataalamat">
							...
							<button type='button' id='btnCariNama' onclick="cariNama('<?php echo $caption_jenis_alamat ?>')" >Cari</button>
...
<script>
	$(function() {
		if($("#cari").val() !== ''){
			var formalamat = document.querySelector('#formalamat')
			var tabform = document.querySelector('#tabform')

			var dataalamat = document.querySelector('#dataalamat')
			var tabdata = document.querySelector('#tabdata')

			formalamat.classList.remove('active');
			tabform.classList.remove('active');

			dataalamat.classList.add('active');
	...
	function cariNama(tipe) {
		...
		let nopesanan = $("#nopesanan").val();
		let idmember = $("#idmember").val();
		let jenisalamat = $("#jenis_alamat").val();
		let totberat = $("#totberat").val();

		var url = $('#frmeditlamat').prop("action") + '?modul=cariNama' + '&u_token=<?php echo $u_token ?>';

		var zdata = nopesanan + '::' + idmember + '::' + jenisalamat + '::' + tipe + '::' + totberat + '::addorder';
