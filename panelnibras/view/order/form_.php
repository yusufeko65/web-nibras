					...
					<tbody>
						...
						<tr>
							...
							<td class="text-right">(<?php echo $dtFungsi->fFormatuang($order['biaya_packing']) ?> )
								...
								<input type="hidden" name="biaya_packing" id="biaya_packing" value="<?php echo $order['biaya_packing'] ?>">
						...
						<tr>
							...
							<td class="text-right">
								...
								<?php $grandtotal = ((int) $order['pesanan_kurir'] + (int) $order['pesanan_subtotal']) - (int) $order['dari_poin'] + (int) $order['biaya_packing'] - (int) $order['dari_deposito']; ?>
