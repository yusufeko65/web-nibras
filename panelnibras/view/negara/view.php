	  ...
	  <table class="table table-bordered table-striped table-hover tabel-grid">
		<thead>
		   <tr>
			  ...
			  <td style="min-width:92%">Nama Negara</td>
		...
		<tbody id="viewdata">
		   ...
		   <tr>
			   <td class="tengah"><input type="checkbox" class="chk" value="<?php echo $datanya['negara_id']?>" /></td>
			   <td><?php echo $datanya["negara_nama"]?></td>
			   <td class="tengah"><a href="<?php echo URL_PROGRAM_ADMIN.folder."/?op=edit&pid=".$datanya['negara_id']?>" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-pencil"></span></a></td>
		   </tr>
		   <?php } ?>
		</tbody>
	   </table>
