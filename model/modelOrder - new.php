...
class model_Order
{
	...
	function getOrderByID($noorder)
	{
		...
		$sql = "select o.pesanan_no,o.pelanggan_id,o.pesanan_jml,
				...
				o.no_awb,o.dari_deposito,o.deposito_agen,o.kurir_konfirm,o.keterangan,
				...
				cg.cg_dropship,cust.cust_reff,id_konfirm,jml_bayar,bank_rek_tujuan,
				...
				inner join _customer cust on o.pelanggan_id = cust.cust_id
