<div class="col-xs-9 hskonten">
  <div class="judul-konten"><h2><?php echo $namaprodusen ?></h2></div>
		   ...
		   <div class="col-md-12  platproduk">
		    <?php if($ambildata) { ?>
			   ...
			   <div class="listproduk" rel="semiinfo-produk<?php echo $asid ?>">
			        <a class="imgproduk" href="<?php echo URL_PROGRAM.$datanya['alias_url'] ?>" title="<?php echo $datanya['nama_produk']; ?>">
