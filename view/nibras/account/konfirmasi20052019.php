<div class="container">
	...
	<form method="POST" name="frmkonfirmasi" enctype="multipart/form-data" id="frmkonfirmasi" action="<?php echo URL_PROGRAM.$amenu.'/'?>">
		...
		<div class="area-form align-items-center">
			...
			<div class="text-center"><h3>Order sudah diisi form konfirmasi</h3></div>
			<?php } else { ?>
			<div class="form-group row">
				<label class="col-md-4">No. Order</label>
				<div class="col-md-4">
					<input type="text" class="form-control elmi" name="noorder" id="noorder" placeholder="Masukkan No. Order" value="<?php echo $dataorder != false ? sprintf('%08s', (int)$dataorder['pesanan_no']) : '' ?>">
					<cite>ex : No Order #0000001, cukup masukkan angka 1</cite>
				</div>
			</div>
			<div class="form-group row">
