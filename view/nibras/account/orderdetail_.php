<div class="container">
	...
	<form id="frmorder" autocomplete="off" action="<?php echo URL_PROGRAM . 'orderdetail' ?>">
		...
		<input type="hidden" id="nama_pengirim" name="nama_pengirim" value="<?= $dataorder['nama_pengirim'] ?>" >
		<input type="hidden" id="hp_pengirim" name="hp_pengirim" value="<?= $dataorder['hp_pengirim'] ?>" >
		<input type="hidden" id="alamat_pengirim" name="alamat_pengirim" value="<?= $dataorder['alamat_pengirim'] ?>" >
		<input type="hidden" id="propinsi_pengirim" name="propinsi_pengirim" value="<?= $dataorder['propinsi_pengirim'] ?>" >
		<input type="hidden" id="kabupaten_pengirim" name="kabupaten_pengirim" value="<?= $dataorder['kota_pengirim'] ?>" >
		<input type="hidden" id="kecamatan_pengirim" name="kecamatan_pengirim" value="<?= $dataorder['kecamatan_pengirim'] ?>" >
		<input type="hidden" id="kelurahan_pengirim" name="kelurahan_pengirim" value="<?= $dataorder['kelurahan_pengirim'] ?>" >
		<input type="hidden" id="kodepos_pengirim" name="kodepos_pengirim" value="<?= $dataorder['kodepos_pengirim'] ?>" >
		
		<input type="hidden" id="nama_penerima" name="nama_penerima" value="<?= $dataorder['nama_penerima'] ?>" >
		<input type="hidden" id="hp_penerima" name="hp_penerima" value="<?= $dataorder['hp_penerima'] ?>" >
		<input type="hidden" id="alamat_penerima" name="alamat_penerima" value="<?= $dataorder['alamat_penerima'] ?>" >
		<input type="hidden" id="propinsi_penerima" name="propinsi_penerima" value="<?= $dataorder['propinsi_penerima'] ?>" >
		<input type="hidden" id="kabupaten_penerima" name="kabupaten_penerima" value="<?= $dataorder['kota_penerima'] ?>" >
		<input type="hidden" id="kecamatan_penerima" name="kecamatan_penerima" value="<?= $dataorder['kecamatan_penerima'] ?>" >
		<input type="hidden" id="kelurahan_penerima" name="kelurahan_penerima" value="<?= $dataorder['kelurahan_penerima'] ?>" >
		<input type="hidden" id="kodepos_penerima" name="kodepos_penerima" value="<?= $dataorder['kodepos_penerima'] ?>" >
		...
		<div class="col-sm-12">
			...
			<table class="table table-bordered">
				...
				<?php if ($dataorder['biaya_packing'] > 0) { ?>
				...
				<tr>
					...
					<td class="text-right"><b><?php echo $dataorder['kurir_konfirm'] == '1' ? 'Konfirmasi Admin' : $dtFungsi->fFormatuang(((int)$total + (int)$dataorder['pesanan_kurir']) + (int)$dataorder['biaya_packing'] - (int)$dataorder['dari_poin'] - (int)$dataorder['dari_deposito']) ?></b></td>
				</tr>
