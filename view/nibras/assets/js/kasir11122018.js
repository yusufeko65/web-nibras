			...
			if(json['status'] == 'error') {
				...
				for(i=0;i<json['result'].length;i++){
					if(json['result'][i]['shipping_konfirmadmin'] != '1') { 
						html += '<option value="'+json['result'][i]['servis_id']+'">'+json['result'][i]['shipping_kode']+' - ' + json['result'][i]['servis_code'] +' ('+ json['result'][i]['keterangan'] +' Hari) - '+ json['result'][i]['hrg_perkilo'] +'</option>';
					} else {
						html += '<option value="'+json['result'][i]['servis_id']+'">'+json['result'][i]['shipping_kode']+' - ' + json['result'][i]['servis_code'] +' - '+ json['result'][i]['hrg_perkilo'] +'</option>';
					}
				}
